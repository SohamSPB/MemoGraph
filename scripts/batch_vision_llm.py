...
def process_trip(trip_folder: str):
    ...
    # Filter rows that need processing. Skip content duplicates — their
    # vision_caption is copied from the canonical by dedup_broadcast.py
    # after this step runs, so spending ~40s of LLaVA inference per duplicate
    # would just be repeating identical work.
    to_process = []
